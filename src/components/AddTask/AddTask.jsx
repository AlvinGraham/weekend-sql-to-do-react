...
export default function AddTask (props) {
  ...
  return (
    <div id ="AddTaskDiv">
      <h2>ADD TASKS</h2>
      <form onSubmit={submitTaskHandler} id="entryAreas">
        <section id="textInputs">
          <label id="titleLabel">Task Title:
            <input 
              type="text" 
          ...
          <br/>
          <label id="descriptionLabel"><span>Task Description:</span>
            <textarea
              type="text>" 
        ...
        <button type="submit" id="buttonInputs">Add New Task</button>
      </form>
    </div>
  );
}